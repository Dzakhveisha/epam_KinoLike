...
<fmt:bundle basename="pagecontent" prefix="admin.">
    ...
    <div id="mainContent">
        ...
        <div id="filmsCont">
            ...
            <button id="addNewFilm"
                    onclick="window.location.href = '${pageContext.request.contextPath}/controller?command=show_new_film'">
                ...
                <c:forEach var="film" items="${requestScope.films}">
                    ...
                    <div class="filmItem">
                        <form enctype="multipart/form-data" class="enterForm"
                            ...
                            <div class="chooseFile">
                                <button type="button" class="btnFile"
                                        onclick="document.getElementById('poster${film.id}').click();">
                                    <fmt:message key="chooseImg"/>
                                </button>
                                <input class="fileNameInput" readonly id="fileName${film.id}" name="fileName"
                                       value="${film.imagePath}"><br>
                                <input style="display:none" type="file" id="poster${film.id}" name=image
                                       value="${film.imagePath}"
                            ...
                            <input required type="text" id="fieldCountry" name="country"
                                   value="${film.countryName}"><br>
                            <label for="fieldDescript"> <fmt:message key="description"/> </label><br>
                            <textarea rows="15" cols="90" required id="fieldDescript"
                        ...
                        <button class="btnDelete"
                                onclick="window.location.href ='${pageContext.request.contextPath}/controller?command=delete_film&film=${film.name}'">
