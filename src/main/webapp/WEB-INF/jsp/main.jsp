    ...
    <div id="movies">
        <c:if test="${not empty requestScope.films}">
            <c:forEach var="film" items="${requestScope.films}">
                <div class="movieItem">
                    <img src="${pageContext.request.contextPath}/img/poster.png" alt="постер">
                    <div class="textDescription">
                        ...
                        <div class="buttons">
                            <button class="setReview" type="button">
                                <a href="${pageContext.request.contextPath}/controller?command=show_review&film=${film.name}">Оставить отзыв</a>
                            </button>
